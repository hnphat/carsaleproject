...
@section('content_header')
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">QUẢN LÝ MÀU XE</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./admin">Trang chủ</a></li>
              <li class="breadcrumb-item">Quản lý xe</li>
              <li class="breadcrumb-item active">Màu xe</li>
            </ol>
          </div>
        </div>
      </div>
...
<button id="addMauXe" class="btn btn-success" data-toggle="modal" data-target="#addMauXeModal" class="btn btn-primary center-block">Thêm mới</button><br/><br/>
<!-- Modal Add -->
<div class="modal fade" id="addMauXeModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
