...
<form id="addTinXeForm" method="post" autocomplete="off">
  @csrf
  <i><strong class="text-danger" id="thongBaoTinXe"></strong></i>
  ...
  <div class="form-group">
      <button type="submit" id="taoDongXe" class="btn btn-primary">&nbsp;&nbsp;&nbsp;Thêm&nbsp;&nbsp;&nbsp;</button>
  </div> <!-- form-group// -->                                                            
</form>
</div>
@endsection
